...
import { Film, Search, TrendingUp, Star, Award, Bell, User, Home, Tv, List } from 'lucide-react';
import { motion } from 'framer-motion';
import { Button } from '@/components/ui/button';
import { RootState, AppDispatch } from '@/store/movie-store';
import { setActiveCategory, clearMovies, fetchTrendingMovies, fetchTopRatedMovies, fetchAwardWinners } from '@/store/movie-store';

export default function MoviesPage() {
  const dispatch = useDispatch<AppDispatch>();
  const { activeCategory, currentView } = useSelector((state: RootState) => state.movies);
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <Search className="w-5 h-5 text-gray-700 dark:text-white cursor-pointer hover:text-primary dark:hover:text-gray-300 transition-colors" />
              <div className="relative">
                <Bell className="w-5 h-5 text-gray-700 dark:text-white cursor-pointer hover:text-primary dark:hover:text-gray-300 transition-colors" />
                <div className="absolute -top-1 -right-1 w-2 h-2 bg-primary rounded-full"></div>
              </div>
              <div className="w-8 h-8 bg-primary rounded-md flex items-center justify-center cursor-pointer shadow-md hover:bg-primary/90 transition-colors">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-8 leading-relaxed">
              Watch anywhere. Cancel anytime. Discover your next favorite movie or series with our powerful search engine.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <Button variant="outline" className="netflix-secondary-button text-lg px-8 py-4">
                Learn More
              </Button>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center space-x-8 mb-8">
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
            >
              <TrendingUp className={`w-5 h-5 ${activeCategory === 'trending' ? 'text-white' : 'text-green-500'}`} />
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Star className={`w-5 h-5 ${activeCategory === 'top-rated' ? 'text-white' : 'text-yellow-500'}`} />
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Award className={`w-5 h-5 ${activeCategory === 'award-winners' ? 'text-white' : 'text-purple-500'}`} />
      ...
      <footer className="bg-gray-100 dark:bg-black/50 border-t border-gray-200 dark:border-gray-800 mt-16">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <h3 className="text-gray-900 dark:text-white font-semibold mb-4">Browse</h3>
              <ul className="space-y-2 text-gray-600 dark:text-gray-400 text-sm">
                <li><button onClick={() => handleNavClick('movies')} className="hover:text-gray-900 dark:hover:text-white transition-colors">Movies</button></li>
                <li><button onClick={() => handleNavClick('tv-shows')} className="hover:text-gray-900 dark:hover:text-white transition-colors">TV Shows</button></li>
                <li><a href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">Documentaries</a></li>
                <li><a href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">Kids</a></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600 dark:text-gray-400 text-sm">
                <li><a href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">Facebook</a></li>
                ...
                <li><a href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">YouTube</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-200 dark:border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              © 2024 CineSearch. All rights reserved. Built with Next.js and shadcn/ui.
            </p>
          </div>
        </div>
      </footer>
