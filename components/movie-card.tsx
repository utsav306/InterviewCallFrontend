      ...
      <Card className="overflow-hidden h-full bg-white dark:bg-gray-900/50 border-gray-200 dark:border-gray-800 movie-card-hover group-hover:border-primary/50 dark:group-hover:border-gray-600 transition-all duration-300 backdrop-blur-sm shadow-lg">
        <div className="relative aspect-[2/3] overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
            <Link href={`/movies/${movie.imdbID}`} className="w-full h-full flex items-center justify-center">
              <motion.div
                initial={{ scale: 0 }}
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 transform translate-y-full group-hover:translate-y-0 transition-all duration-300">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <Button size="sm" className="bg-white text-black hover:bg-gray-200 rounded-full w-8 h-8 p-0 shadow-md">
                  <Play className="w-4 h-4 fill-black" />
                </Button>
                <Button size="sm" variant="outline" className="bg-transparent border-white/50 text-white hover:bg-white/10 rounded-full w-8 h-8 p-0">
        ...
        <CardContent className="p-4 space-y-3">
          ...
          <div className="flex items-center justify-between text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="flex items-center space-x-1">
              ...
              <span className="text-gray-900 dark:text-white font-medium">8.5</span>
            </div>
          </div>
          
          {/* Match Percentage */}
          <div className="flex items-center justify-between">
            <span className="text-green-500 font-semibold text-sm">98% Match</span>
            <Badge variant="outline" className="border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 text-xs">
              HD
            </Badge>
          </div>
        </CardContent>
